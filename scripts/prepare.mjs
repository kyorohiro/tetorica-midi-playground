...
const guides={};
for(const name of ['README.md','README_jp.md','lib/README.md','lib/README_jp.md']) guides['/'+name]=await readFile(new URL('ui/'+name,base),'utf8');
...
const examples={};
for(const name of ['01_multi_output.js','02_assigned_outputs.js','03_context_jsdoc.js','04_first_note.js','05_live_loop.js','06_multi_channel.js','07_external_output.js','08_output_slots.js','09_library.js','10_context_init.js','11_midi_pitch_bend.js','12_midi_cc.js','13_ym2612_voice.js','14_ym2612_fixed_channels.js','15_ym2612_auto_chord.js','lead.js','melody.js'])examples['/examples/'+name]=await readFile(new URL('ui/examples/'+name,base),'utf8');
examples['/lib/phrase.js']=await readFile(new URL('ui/lib/phrase.js',base),'utf8');
