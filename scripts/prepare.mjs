...
const examples={};
for(const name of ['01_multi_output.js','02_assigned_outputs.js','03_context_jsdoc.js','04_first_note.js','05_live_loop.js','06_multi_channel.js','07_external_output.js','08_output_slots.js','09_library.js'])examples['/examples/'+name]=await readFile(new URL('ui/examples/'+name,base),'utf8');
