...
const examples={};
for(const name of ['01_multi_output.js','02_assigned_outputs.js','03_context_jsdoc.js'])examples['/examples/'+name]=await readFile(new URL('ui/examples/'+name,base),'utf8');
